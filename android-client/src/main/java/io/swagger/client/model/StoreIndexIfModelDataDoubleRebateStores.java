/**
 * 五五海淘返利APP新版接口
 * 更新日志<br> 相对于上一build的变更： <br/> 热品库结构调整 
 *
 * OpenAPI spec version: 1.7 build20171207-3
 * 
 *
...
public class StoreIndexIfModelDataDoubleRebateStores  {
  ...
  public boolean equals(Object o) {
    ...
    StoreIndexIfModelDataDoubleRebateStores storeIndexIfModelDataDoubleRebateStores = (StoreIndexIfModelDataDoubleRebateStores) o;
    return (storeId == null ? storeIndexIfModelDataDoubleRebateStores.storeId == null : storeId.equals(storeIndexIfModelDataDoubleRebateStores.storeId)) &&
        (storeName == null ? storeIndexIfModelDataDoubleRebateStores.storeName == null : storeName.equals(storeIndexIfModelDataDoubleRebateStores.storeName)) &&
        (categoryName == null ? storeIndexIfModelDataDoubleRebateStores.categoryName == null : categoryName.equals(storeIndexIfModelDataDoubleRebateStores.categoryName)) &&
        (storeLogo == null ? storeIndexIfModelDataDoubleRebateStores.storeLogo == null : storeLogo.equals(storeIndexIfModelDataDoubleRebateStores.storeLogo)) &&
        (countryFlagPic == null ? storeIndexIfModelDataDoubleRebateStores.countryFlagPic == null : countryFlagPic.equals(storeIndexIfModelDataDoubleRebateStores.countryFlagPic)) &&
        (rebateView == null ? storeIndexIfModelDataDoubleRebateStores.rebateView == null : rebateView.equals(storeIndexIfModelDataDoubleRebateStores.rebateView)) &&
        (rebateInfluenceView == null ? storeIndexIfModelDataDoubleRebateStores.rebateInfluenceView == null : rebateInfluenceView.equals(storeIndexIfModelDataDoubleRebateStores.rebateInfluenceView)) &&
        (collectionsCountView == null ? storeIndexIfModelDataDoubleRebateStores.collectionsCountView == null : collectionsCountView.equals(storeIndexIfModelDataDoubleRebateStores.collectionsCountView)) &&
        (alipaySupported == null ? storeIndexIfModelDataDoubleRebateStores.alipaySupported == null : alipaySupported.equals(storeIndexIfModelDataDoubleRebateStores.alipaySupported)) &&
        (directPostSupported == null ? storeIndexIfModelDataDoubleRebateStores.directPostSupported == null : directPostSupported.equals(storeIndexIfModelDataDoubleRebateStores.directPostSupported)) &&
        (cnWebSupported == null ? storeIndexIfModelDataDoubleRebateStores.cnWebSupported == null : cnWebSupported.equals(storeIndexIfModelDataDoubleRebateStores.cnWebSupported));
  }
  ...
  public String toString()  {
    ...
    sb.append("class StoreIndexIfModelDataDoubleRebateStores {\n");
