/**
 * 五五海淘返利APP新版接口
 * 更新日志<br> 相对于上一build的变更： <br/> 增加当日是否已签到信息 
 *
 * OpenAPI spec version: 1.2 build20170630-2
 * 
 *
...
public class UserModel  {
  ...
  /**
   * 是否是好友 - 0：不是好友 1：已是好友 2：自己 3:已向对方发送过好友请求
   **/
  @ApiModelProperty(value = "是否是好友 - 0：不是好友 1：已是好友 2：自己 3:已向对方发送过好友请求")
  ...
  public boolean equals(Object o) {
    ...
    return (uid == null ? userModel.uid == null : uid.equals(userModel.uid)) &&
        (username == null ? userModel.username == null : username.equals(userModel.username)) &&
        (groupName == null ? userModel.groupName == null : groupName.equals(userModel.groupName)) &&
        (topicsCount == null ? userModel.topicsCount == null : topicsCount.equals(userModel.topicsCount)) &&
        (postsCount == null ? userModel.postsCount == null : postsCount.equals(userModel.postsCount)) &&
        (digestTopicsCount == null ? userModel.digestTopicsCount == null : digestTopicsCount.equals(userModel.digestTopicsCount)) &&
        (avatar == null ? userModel.avatar == null : avatar.equals(userModel.avatar)) &&
        (isFriend == null ? userModel.isFriend == null : isFriend.equals(userModel.isFriend));
  }
