...
public class ImageDecodingInfo {
    private final int netWorkType;//网络请求方式
    ...
    public ImageDecodingInfo(String imageKey, String imageUri, String originalImageUri, ImageSize targetSize, ViewScaleType viewScaleType,
        ...
        this.netWorkType = displayOptions.getNetWorkType();
    ...
    /**
     * @return Original {@linkplain com.haitao.utils.universalimageloader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache).
     */
