...
import com.haitao.utils.universalimageloader.cache.disc.naming.FileNameGenerator;
import com.haitao.utils.universalimageloader.cache.memory.MemoryCache;
import com.haitao.utils.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
...
import com.haitao.utils.universalimageloader.core.decode.ImageDecoder;
import com.haitao.utils.universalimageloader.core.download.ImageDownloader;
import com.haitao.utils.universalimageloader.core.process.BitmapProcessor;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.haitao.utils.universalimageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		 ...
		 * {@link com.haitao.utils.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.haitao.utils.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.haitao.utils.universalimageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.haitao.utils.universalimageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.haitao.utils.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.haitao.utils.universalimageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.haitao.utils.universalimageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.haitao.utils.universalimageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.haitao.utils.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.haitao.utils.universalimageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.haitao.utils.universalimageloader.utils.L#disableLogging()} to disable
	...
	private static class NetworkDeniedImageDownloader implements ImageDownloader {
		...
		@Override
		public InputStream getStream(String imageUri, Object extra,int netWorkType) throws IOException {
			switch (Scheme.ofUri(imageUri)) {
				case HTTP:
				case HTTPS:
					throw new IllegalStateException();
				default:
					return wrappedDownloader.getStream(imageUri, extra,netWorkType);
			}
		}
	}
	...
	private static class SlowNetworkImageDownloader implements ImageDownloader {
		...
		@Override
		public InputStream getStream(String imageUri, Object extra,int netWorkType) throws IOException {
			InputStream imageStream = wrappedDownloader.getStream(imageUri, extra,netWorkType);
			switch (Scheme.ofUri(imageUri)) {
				case HTTP:
				case HTTPS:
