 ...
 *******************************************************************************/
package com.haitao.utils.universalimageloader.core.decode;
...
public class BaseImageDecoder implements ImageDecoder {
     ...
     *                       com.haitao.utils.universalimageloader.core.ImageLoaderConfiguration.Builder#writeDebugLogs()
    ...
    protected InputStream getImageStream(ImageDecodingInfo decodingInfo) throws IOException {
        return decodingInfo.getDownloader().getStream(decodingInfo.getImageUri(), decodingInfo.getExtraForDownloader(), decodingInfo.getNetWorkType());
    }
