...
class ImageLoaderEngine {
	...
	ImageLoaderEngine(ImageLoaderConfiguration configuration) {
		...
		taskDistributor = DefaultConfigurationFactory.createTaskDistributor(configuration.threadPoolSize);
//		taskDistributor = DefaultConfigurationFactory.createTaskDistributor();
	 ...
	 * {@linkplain com.haitao.utils.universalimageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(Executor)
