 ...
 *******************************************************************************/
package com.haitao.utils.universalimageloader.core.imageaware;
 ...
 * through {@link com.haitao.utils.universalimageloader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link com.haitao.utils.universalimageloader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	 ...
	 * {@link com.haitao.utils.universalimageloader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain com.haitao.utils.universalimageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *Drawable) for empty Uri},
	 * {@linkplain com.haitao.utils.universalimageloader.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *Drawable) on loading} or
	 * {@linkplain com.haitao.utils.universalimageloader.core.DisplayImageOptions.Builder#showImageOnFail(
	 *Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain com.haitao.utils.universalimageloader.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link com.haitao.utils.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 ...
	 * {@link com.haitao.utils.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
