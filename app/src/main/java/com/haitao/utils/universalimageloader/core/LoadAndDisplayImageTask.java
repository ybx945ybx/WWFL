...
import com.haitao.utils.universalimageloader.core.assist.FailReason.FailType;
...
import com.haitao.utils.universalimageloader.core.decode.ImageDecodingInfo;
import com.haitao.utils.universalimageloader.core.download.ImageDownloader;
import com.haitao.utils.universalimageloader.core.download.ImageDownloader.Scheme;
...
import com.haitao.utils.universalimageloader.utils.IoUtils;
...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
    ...
    private boolean downloadImage() throws IOException {
        InputStream is = getDownloader().getStream(uri, options.getExtraForDownloader(), options.getNetWorkType());
        if (is == null) {
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                if (options.shouldShowImageOnFail()) {
                    imageAware.setImageResource(options.getImageOnFail());
