 ...
 *******************************************************************************/
package com.haitao.utils.universalimageloader.core;
...
import com.haitao.utils.universalimageloader.cache.disc.DiskCache;
import com.haitao.utils.universalimageloader.cache.memory.MemoryCache;
import com.haitao.utils.universalimageloader.core.assist.FailReason;
import com.haitao.utils.universalimageloader.core.assist.FlushedInputStream;
import com.haitao.utils.universalimageloader.core.assist.ImageSize;
import com.haitao.utils.universalimageloader.core.assist.LoadedFrom;
import com.haitao.utils.universalimageloader.core.assist.ViewScaleType;
import com.haitao.utils.universalimageloader.core.imageaware.ImageAware;
import com.haitao.utils.universalimageloader.core.imageaware.ImageViewAware;
import com.haitao.utils.universalimageloader.core.imageaware.NonViewAware;
import com.haitao.utils.universalimageloader.core.listener.ImageLoadingListener;
import com.haitao.utils.universalimageloader.core.listener.ImageLoadingProgressListener;
import com.haitao.utils.universalimageloader.core.listener.SimpleImageLoadingListener;
import com.haitao.utils.universalimageloader.utils.ImageSizeUtils;
import com.haitao.utils.universalimageloader.utils.L;
import com.haitao.utils.universalimageloader.utils.MemoryCacheUtils;
 ...
 *
 * @author Sergey Tarasevich (haitao.utils[at]gmail[dot]com)
 * @since 1.0.0
 */
public class ImageLoader {
	...
	public void displayImage(String uri, ImageAware imageAware) {
		displayImage(uri, imageAware, null,null, null, null);
	}
	...
	public void displayImage(String uri, ImageAware imageAware, ImageLoadingListener listener) {
		displayImage(uri, imageAware, null, null,listener, null);
	}
	 ...
	 * @param imageAware {@linkplain ImageAware Image aware view}
	 *                   which should display image
	 * @param options    {@linkplain com.haitao.utils.universalimageloader.core.DisplayImageOptions Options} for image
	...
	public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options) {
		displayImage(uri, imageAware, options,null, null, null);
	}
	...
	public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,
		...
		displayImage(uri, imageAware, options,null, listener, null);
	}
	 ...
	 *                         {@linkplain com.haitao.utils.universalimageloader.core.DisplayImageOptions options} to make
	 *                         this listener work.
	 * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,ImageSize targetSize,
		...
		if (TextUtils.isEmpty(uri)) {
			...
			if (options.shouldShowImageForEmptyUri()) {
				imageAware.setImageResource(options.getImageForEmptyUri());
//				imageAware.setImageDrawable(options.getImageForEmptyUri(configuration.resources));
		...
		if (bmp != null && !bmp.isRecycled()) {
			...
			if (options.shouldShowImageOnLoading()) {
				imageAware.setImageResource(options.getImageOnLoading());
//				imageAware.setImageDrawable(options.getImageOnLoading(configuration.resources));
	...
	public void displayImage(String uri, ImageView imageView,ImageSize targetSize) {
		displayImage(uri, new ImageViewAware(imageView), null,targetSize, null, null);
	}
	/**
	 * Adds display image task to execution pool. Image will be set to ImageView when it's turn.<br />
	 * <b>NOTE:</b> {@link #init(ImageLoaderConfiguration)} method must be called before this method call
	...
	public void displayImage(String uri, ImageView imageView, DisplayImageOptions options,ImageSize targetSize) {
		displayImage(uri, new ImageViewAware(imageView), options,targetSize, null, null);
	}
	/**
	 * Adds display image task to execution pool. Image will be set to ImageView when it's turn.<br />
	 * Default {@linkplain DisplayImageOptions display image options} from {@linkplain ImageLoaderConfiguration
	...
	public void displayImage(String uri, ImageView imageView, ImageLoadingListener listener) {
		displayImage(uri, new ImageViewAware(imageView), null,null, listener, null);
	}
	public void displayImage(String uri, ImageView imageView,ImageSize targetSize ,ImageLoadingListener listener) {
		displayImage(uri, new ImageViewAware(imageView), null,targetSize, listener, null);
	}
	/**
	 * Adds display image task to execution pool. Image will be set to ImageView when it's turn.<br />
	 * <b>NOTE:</b> {@link #init(ImageLoaderConfiguration)} method must be called before this method call
	...
	public void displayImage(String uri, ImageView imageView, DisplayImageOptions options,ImageSize targetSize,
							 ImageLoadingListener listener) {
		displayImage(uri, imageView, options, targetSize,listener, null);
	}
	/**
	 * Adds display image task to execution pool. Image will be set to ImageView when it's turn.<br />
	 * <b>NOTE:</b> {@link #init(ImageLoaderConfiguration)} method must be called before this method call
	...
	public void displayImage(String uri, ImageView imageView, DisplayImageOptions options,
			ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
		displayImage(uri, new ImageViewAware(imageView), options,null, listener, progressListener);
	}
	public void displayImage(String uri, ImageView imageView, DisplayImageOptions options,ImageSize targetSize,
							 ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
		displayImage(uri, new ImageViewAware(imageView), options,targetSize, listener, progressListener);
	}
	/**
	 ...
	 * {@linkplain com.haitao.utils.universalimageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
