...
public abstract class ViewAware implements ImageAware {
	...
	public static final String WARN_CANT_SET_RESOURCE = "Can't set a Resource into view. You should call ImageLoader on UI thread for it.";
	 ...
	 *                            <a href="https://github.com/haitao.utils/Android-Universal-Image-Loader/issues/376">this</a>.
	...
	public boolean setImageResource(int resId) {
		if (Looper.myLooper() == Looper.getMainLooper()) {
			View view = viewRef.get();
			if (view != null) {
				setImageResourceInto(resId, view);
				return true;
			}
		} else {
			L.w(WARN_CANT_SET_RESOURCE);
		}
		return false;
	}
	...
	protected abstract void  setImageResourceInto(int resId,View view);
}
