...
public class StickyNavLayout extends LinearLayout {
    ...
    private OnTopHiddenListener mOnTopHiddenListener;
...
//                Logger.d("dy = " + dy + " , y = " + y + " , mLastY = " + mLastY);
    ...
    public void scrollTo(int x, int y) {
        ...
        if (null != this.mOnTopHiddenListener) {
            this.mOnTopHiddenListener.onRefresh(isTopHidden);
        }
    ...
    public void setOnTopHiddenListener(OnTopHiddenListener onTopHiddenListener) {
        this.mOnTopHiddenListener = onTopHiddenListener;
    }


    public interface OnTopHiddenListener {
        void onRefresh(boolean status);
    }
