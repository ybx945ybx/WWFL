...
public class XExpandableListView extends ExpandableListView implements OnScrollListener {
    ...
    private IXExpandableListViewListener mListener;

    //    private XListViewHeaderNew mHeader;
    //    private XListViewHeaderNew mHeader;
    ...
    private void initWithContext(Context context) {
        ...
        // init header view
        //		mHeader = new XListViewHeaderNew(mContext);
     ...
     * @param listener
     */
    public void setIXExpandableListViewListener(IXExpandableListViewListener listener) {
        mListener = listener;
    }
