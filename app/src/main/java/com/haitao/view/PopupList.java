...
public class PopupList {
     ...
     *
     * @param anchorView        the view on which to pin the popup window
     * @param contextPosition   mContext position
    ...
    public interface PopupListListener {
         ...
         *
         * @param adapterView     The mContext view(The AbsListView where the click happened or normal view).
         ...
         * been clicked
         *
         * @param contextView     The mContext view(The AbsListView where the click happened or normal view).
         * @param contextPosition The position of the view in the list
